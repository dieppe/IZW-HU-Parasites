...
def build_nodelist(nodelist, subtree, known_states, depth, stats):
    ott = subtree.name
    #                   0    1              2       3       4           5
    ...
    if subtree.is_terminal():
        ...
        min_height, max_height, mean_height, child_height = [
            float('inf'), 0, 0, 0
        ]
        for clade in subtree.clades:
            # Build nodelist for children first
            heights = build_nodelist(
            ...
            # Add the child mean height to the current sum of all children
            # mean height
